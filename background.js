...
},
{
  ...
  'name': 'Codeship',
  'difficulty': 'medium',
  'description': 'Submit 15 builds in 30 days, get t-shirts & stickers sent your way! (Ships only to North America and Europe)',
...
},
{
  ...
  'name': 'Digital Ocean',
  'difficulty': 'hard',
  'description': 'Make five pull requests in October, earn a limited edition T-shirt!',
  'reference': 'https://hacktoberfest.digitalocean.com/',
  'image': 'https://user-images.githubusercontent.com/121322/45907730-f6a80b00-bdad-11e8-93ef-774392192716.png',
  'dateAdded': '2018-02-18T07:48:58.000Z',
  'tags': ['clothing', 'hacktoberfest', 'expired', 'stickers']
},
{
  'id': 's10',
...
},
{
  ...
  'name': 'JS Bin',
  'difficulty': 'easy',
  'description': 'Fill out a Google form with your name and address and get a sticker. There’s no cost to you, but they will be restricting the send outs to bi-monthly or quaterly depending on demand.',
...
},
{
  ...
  'name': 'LBRY',
  'difficulty': 'medium',
  'description': 'A sweet T-shirt for anyone who submits 3 Pull Requests. A Lamborghini Aventador S for anyone who submits 800,000 accepted PRs.',
  'reference': 'https://lbry.io/news/hacktoberfest',
  'image': 'https://pbs.twimg.com/media/Dowf_X5XkAAXR3T.jpg',
  'dateAdded': '2018-10-22T21:19:41.000Z',
...
},
{
  ...
  'name': 'Magento',
  'difficulty': 'hard',
  'description': 'Have 5 merged PRs or validate at least 10 issues in October 2018, get a Squashtoberfest T-Shirt!',
  'reference': 'https://github.com/magento/magento2/wiki/SQUASHTOBERFEST-2018',
  'image': 'https://raw.githubusercontent.com/wiki/magento-engcom/msi/images/squash2018.png',
  'dateAdded': '2018-10-23T10:17:39.000Z',
  'tags': ['clothing', 'hacktoberfest', 'expired']
},
{
  'id': 's17',
  ...
  'image': 'https://open.microsoft.com/wp-content/uploads/2018/09/Hacktoberfest-Blog.jpg',
...
},
{
  ...
  'name': 'Mullvad',
  'difficulty': 'easy',
  'description': 'Send an email to Mullvad to get an assortment of stickers sent your way.',
  'reference': 'https://www.mullvad.net/en/guides/mullvad-stickers-and-merchandise/',
  'image': 'https://www.mullvad.net/media/uploads/2017/10/20/mullvad-stickers.jpg',
  'dateAdded': '2018-03-11T16:47:14.000Z',
  'tags': ['stickers']
},
{
  'id': 's19',
  ...
  'image': 'https://d2odgkulk9w7if.cloudfront.net/images/default-source/default-album/stickers-photo.jpg',
...
},
{
  ...
  'name': 'Netlify',
  'difficulty': 'easy',
  'description': 'Complete this <a href=\'https://swag.netlify.com/docs/\'>survey</a> about using Netlify for documentation and get stickers.',
  'reference': 'https://swag.netlify.com/docs/',
...
},
{
  ...
  'image': 'https://partners.npmjs.com/weekly/weekly30/socks-1100x.jpg',
...
},
{
  ...
  'name': 'Operation Code',
  'difficulty': 'easy',
  'description': 'Close 3 issues, get a t-shirt. Make a PR and get stickers.',
  'reference': 'https://github.com/OperationCode/START_HERE',
  'image': 'https://upload.cc/i1/2018/10/21/yRDFvh.png',
  'dateAdded': '2018-10-28T16:55:45.000Z',
  'tags': ['clothing', 'hacktoberfest', 'expired', 'stickers']
},
{
  'id': 's26',
...
},
{
  ...
  'dateAdded': '2018-12-04T5:58:05.000Z',
  'tags': ['clothing', 'expired']
},
{
  'id': 's30',
...
// tslint:disable-next-line: max-line-length
  'description': 'Have one accepted pull request in a Umbraco repository during October 2018 to get some super exclusive Umbraco swag. All the contributors will also be listed by Github username in a dedicated blog post in November.',
  'reference': 'https://umbraco.com/blog/happy-hacktoberfest/',
  'image': 'https://shop.umbraco.com/media/2989609/img_0722.jpg',
  'dateAdded': '2018-10-20T12:48:46.000Z',
...
$(document).ready(function(){
    ...
    function swagForDev() {
        ...
        for(var i = 0;i < swags.length; i++) {
            
            if(!swags[i].tags.includes('expired')){

            $('.outer-box').append(`<div class='inner-box'><img onerror="this.onerror=null;this.src='swag.jpg';" alt="Image of `+swags[i].name+`" src='`+swags[i].image+`' width='150' height='150'></div>`);
            $('.outer-box').append(`<div class='inner-box-two'>
                                        <h2><u>`+swags[i].name+`</u></h2>
                                        <h3><b>Description : </b></h3>
                                        <p>`+swags[i].description+`</p>
                                        <h3><b>Difficulty : </b></h3>
                                        <span>`+swags[i].difficulty+`</span><br>
                                        <h3><b>References : </b></h3>
                                        <a href="`+swags[i].reference+`">Click Here for more information</a>
                                    </div>
                                    <hr>`)
